      ...
      <div className="max-w-5xl mx-auto px-6 py-8 lg:py-10 relative">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            {/* GCLBA logo mark */}
            <div className="hidden sm:flex flex-shrink-0 w-14 h-14 rounded-xl bg-accent/10 border-2 border-accent/20 items-center justify-center">
              <span className="font-heading text-[18px] font-bold text-accent leading-none tracking-tight">
                GC
              </span>
            </div>
            <div>
              ...
              <p className="text-sm text-muted mt-1 flex items-center gap-2">
                <span>Buyer Compliance Portal</span>
                <span className="text-warm-200">|</span>
                <span className="text-xs font-mono text-muted/70">Flint, Michigan</span>
              </p>
            </div>
          </div>
